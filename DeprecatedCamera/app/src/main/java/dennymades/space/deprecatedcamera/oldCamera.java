...
public class oldCamera {
    ...
    public void openCamera(){
        try{
            mCamera = Camera.open(CAMERA_FRONT_FACING_ID);
        }catch(RuntimeException e){
            Log.d(HomeActivity.LOG_TAG, "exception", e);
        }
    }
    ...
    public void test(){
        ...
        Log.d(HomeActivity.LOG_TAG, paramString);
    }
    ...
    public void requestPermission(){
        if(ContextCompat.checkSelfPermission(sharedContext, Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(mActivity,
                    ...
                    HomeActivity.CAMERA_PERMISSION_CODE);
        }else{
            startCamera();
        }
    }
    ...
    public void setCameraDisplayOrientation() {
        ...
        android.hardware.Camera.getCameraInfo(CAMERA_FRONT_FACING_ID, info);
