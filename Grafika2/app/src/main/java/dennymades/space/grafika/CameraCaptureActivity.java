...
package dennymades.space.grafika;
...
import dennymades.space.grafika.gles.FullFrameRect;
import dennymades.space.grafika.gles.Texture2dProgram;
...
public class CameraCaptureActivity extends Activity
    ...
    private static dennymades.space.grafika.TextureMovieEncoder sVideoEncoder = new dennymades.space.grafika.TextureMovieEncoder();
    ...
    private void openCamera(int desiredWidth, int desiredHeight) {
        ...
        dennymades.space.grafika.CameraUtils.choosePreviewSize(parms, desiredWidth, desiredHeight);
...
class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private dennymades.space.grafika.TextureMovieEncoder mVideoEncoder;
    ...
    public CameraSurfaceRenderer(CameraCaptureActivity.CameraHandler cameraHandler,
                                 dennymades.space.grafika.TextureMovieEncoder movieEncoder, File outputFile) {
        ...
        if (mRecordingEnabled) {
            switch (mRecordingStatus) {
                case RECORDING_OFF:
                    ...
                    // start recording
                    mVideoEncoder.startRecording(new dennymades.space.grafika.TextureMovieEncoder.EncoderConfig(
